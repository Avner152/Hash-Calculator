     ...
     var div_element = document.getElementsByClassName("wrapper")[0];
      ...
      row.setAttribute("class", "rows")
        ...
        for (let s = 0; s < 3; s++) {
            ...
            var textHead = document.createElement('h2');
            var strHead;
            switch (s){
                case 0:
                    strHead = 'UserName'
            ...
            textHead.innerHTML = strHead;
            cellHead.appendChild(textHead);
          
          cellHead.setAttribute("ClassName", 'cellHead')
...
// var user_names = this.responseText.split('\n');
...
//     var b = document.createTextNode("key: " + user + ", value: " + SHA256(user));
//     a.appendChild(b);
...
// }
// xhttp.open("GET", "https://docs.google.com/spreadsheets/d/e/2PACX-1vSCWi0JkFwj88GHCx7rcdNYIAU--zk4zbybsQkRnku_EL_xQnssQspzSHssT0WS83T3YLDIod2SDRKU/pub?gid=0&single=true&output=csv");
// xhttp.send();
